...
if(isset($_POST['postid'])){
	    ...
	    $postid=$_POST['postid'];
	if(isset($_POST['ident_profesor'])){
	    $ident_profesor=$_POST['ident_profesor'];
	if(isset($_POST['replied'])) 
        {$texts=addslashes($_POST['replied']);
      		$text = mysqli_real_escape_string($mysqli,$texts);
		}
		 if(isset($_POST['replied']))
    	     {  
        	      
				
     	               $query1z = "INSERT INTO colegio_profesor_estudiante_msg(ident_profesor,ident_alumno,sender,mensaje) ".
                    "VALUES ('".$ident_profesor."','".$_SESSION['ident']."','".$_SESSION['ident']."','$text')";
                    $mysqli->query($query1z) or die('Error, query failed:'.$query1z);
              
			}
	   
	$get="SELECT C.ident_profesor,concat(P.profesor_nombres,' ',P.profesor_apellidos),C.ident_alumno,concat(A.alumno_nombres,' ',A.alumno_apellidos),C.sender,C.mensaje,C.hora FROM colegio_profesor_estudiante_msg as C INNER JOIN colegio_profesor as P ON(C.ident_profesor=P.profesor_ident) INNER JOIN colegio_alumno as A ON(C.ident_alumno=A.alumno_ident) WHERE C.ident_profesor='".$ident_profesor."' AND C.ident_alumno='".$_SESSION["ident"]."' ";
						    $gets=mysqli_query($mysqli,$get);						   
      ...
      while($get_row=mysqli_fetch_array($gets))
      {
		 ...
		 $time=strtotime($get_time);
                  $times=date("g:i a",$time);
				      ...
				      if ($get_row[4]!=$_SESSION['ident'])
		           {
		           	          			
		                echo '<li>
                                                <div class="msg-received msg-container">
                                                    <div class="avatar">
                                                       <img src="images/avatar/profesor.png" alt="">
                                                       <div class="send-time">'.$times.'</div>
                                                    </div>
                                                    <div class="msg-box">
                                                        <div class="inner-box">
                                                            <div class="name">
				  	     ...
				  	     echo'<li>
                                                <div class="msg-sent msg-container" style="height:auto; overflow:hidden;">
                                                    <div class="avatar">
                                                       <img src="images/avatar/estudiante.png" alt="">
                                                       <div class="send-time">'.$times.'</div>
                                                    </div>
                                                    <div class="msg-box">
                                                        <div class="inner-box">
        ...
        {$texts=addslashes($_POST['replied']);
		 ...
		 if(isset($_POST['replied']))
    	     {  
     	               ...
     	               $query1z = "INSERT INTO colegio_profesor_estudiante_msg(ident_profesor,ident_alumno,sender,mensaje) ".
                    "VALUES ('".$_SESSION['ident']."','".$ident_alumno."','".$_SESSION['ident']."','$text')";
                    $mysqli->query($query1z) or die('Error, query failed:'.$query1z);
              
			}
	   
	$get="SELECT C.ident_profesor,concat(P.profesor_nombres,' ',P.profesor_apellidos),C.ident_alumno,concat(A.alumno_nombres,' ',A.alumno_apellidos),C.sender,C.mensaje,C.hora FROM colegio_profesor_estudiante_msg as C INNER JOIN colegio_profesor as P ON(C.ident_profesor=P.profesor_ident) INNER JOIN colegio_alumno as A ON(C.ident_alumno=A.alumno_ident) WHERE C.ident_profesor='".$_SESSION["ident"]."' AND C.ident_alumno= '".$ident_alumno."'";
						    $gets=mysqli_query($mysqli,$get);						   
                          $entered=mysqli_num_rows($gets);
              if($entered!=0)
              {
	...
	$get="SELECT C.ident_profesor,concat(P.profesor_nombres,' ',P.profesor_apellidos),C.ident_alumno,concat(A.alumno_nombres,' ',A.alumno_apellidos),C.sender,C.mensaje,C.hora FROM colegio_profesor_estudiante_msg as C INNER JOIN colegio_profesor as P ON(C.ident_profesor=P.profesor_ident) INNER JOIN colegio_alumno as A ON(C.ident_alumno=A.alumno_ident) WHERE C.ident_profesor='".$ident_profesor."' AND C.ident_alumno='".$_SESSION["ident"]."' ";
      ...
      while($get_row=mysqli_fetch_array($gets))
      {
		 ...
		 $time=strtotime($get_time);
       	...
       	echo "<p>Empiece una conversación con esta persona</p>";
       }
    }
